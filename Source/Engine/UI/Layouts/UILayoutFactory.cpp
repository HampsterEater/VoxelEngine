...
HashTable<UILayoutHandle*, int>	UILayoutFactory::m_loaded_layouts;
...
{
	for (HashTable<UILayoutHandle*, int>::Iterator iter = m_loaded_layouts.Begin(); iter != m_loaded_layouts.End(); iter++)
	{

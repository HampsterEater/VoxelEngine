...
def main():
	...
	parser.add_option("-p", "--prefix", dest="prefix", help="Class name prefix to prevent duplicate identifiers in multi-project solutions.")
	...
	UpdateVersionInfo(options.filename, options.prefix)
...
def UpdateVersionInfo(file, prefix):
